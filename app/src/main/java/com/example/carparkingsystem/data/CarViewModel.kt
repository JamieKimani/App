...
class CarViewModel:ViewModel() {
    val cloudinaryUrl = "https://api.cloudinary.com/v1_1/dkbvein2a/image/upload"
    val uploadPreset = "images"

    fun uploadCar(imageUri: Uri?,plateNumber:String,vehicleType:String,driverName:String,phoneNumber:String,color:String,entryTime:String,
